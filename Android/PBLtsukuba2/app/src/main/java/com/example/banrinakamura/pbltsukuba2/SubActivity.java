...
public class SubActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        gcmBroadcastReceiver.setCallbacks(new GcmBroadcastReceiver.Callbacks() {
            @Override
            public void callbackMethod(Intent intent) {
                Log.d("callbackMethod", "called");
                System.out.println("xxxxxx invitee = " + intent.getStringExtra("invitee"));
                System.out.println("xxxxxx status = " + intent.getStringExtra("status"));
            }
        });
